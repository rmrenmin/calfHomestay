<template>
	<div>
		<el-row class="bgt">
			...
			<el-col :span="2" class="cell flexbox" v-if="status==1">
				<span>取消</span>
			</el-col>
			<el-col :span="status==1?2:4" class="flexbox">
				<span>删除</span>
			</el-col>
		</el-row>
		<OrderItem v-for="(item,index) in data" :key="index" v-bind="item"></OrderItem>
		<div class="block">
